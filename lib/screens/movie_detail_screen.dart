...
import 'package:segunda_aplicacion/network/api_cast.dart';
import 'package:segunda_aplicacion/network/trailer.dart';
      ...
      children: [
        ...
        Column(
          children: [
            ...
            if (trailerKey == null) Center(child: CircularProgressIndicator()),
            SizedBox(
              height: 20,
            ),
            RatingStars(
                ...
                ButtonTheme(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                        ...
                        elevation: 0.0,
                        side: const BorderSide(
                            color: Color.fromARGB(255, 243, 230, 0), width: 2),
